...
A simple use case for custom transport can be a fetching from a Provider where data is not ordinarily paginated. Imagine Data Provider returning following response for an arbitrary API endpoint.
